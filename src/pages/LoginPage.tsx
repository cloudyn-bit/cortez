...
export function LoginPage() {
  ...
  const { user, signInWithEmail, signUpWithEmail, signInAsGuest, resetPasswordForEmail, resendVerificationEmail } = useAuth()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      if (lowerMsg.includes('already registered')) {
        ...
        friendlyMessage = 'Invalid email address or format.'
            ...
            {mode === 'verify' ? (
              <div className="relative z-20 flex flex-col items-center text-center space-y-6">
                <motion.div
                  ...
                  className="h-20 w-20 bg-emerald-500/10 rounded-full flex items-center justify-center border border-emerald-500/20"
                >
                ...
                >
                  ...
                  <p className="text-sm text-zinc-400 font-medium max-w-xs mx-auto leading-relaxed">
                    We've sent a verification link to <span className="text-white">{email}</span>. Please verify your account before signing in.
                  </p>
                </motion.div>
                ...
                <AnimatePresence>
                  {message && (
                    <motion.div
                      ...
                      className={`w-full p-4 rounded-xl text-sm flex items-start space-x-3 border backdrop-blur-md ${
                    ...
                    >
                      ...
                      <span className="leading-snug text-left">{message.text}</span>
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                >
                  ...
                  >
                    {loading ? <Loader2 className="h-5 w-5 animate-spin mx-auto" /> : <span>Resend Email</span>}
                  </ShinyButton>
                  ...
                  <div className="flex flex-col gap-2 pt-2">
                    <button
                      ...
                      className="w-full py-2 rounded-xl text-sm font-semibold text-zinc-400 hover:text-white transition-colors"
                    >
                      Back to Sign In
                    </button>
